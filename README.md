...
scenario for the SRM detection layer to flag and 
...
This is intentional. Phase : power analysis will flag the 
experiment as underpowered, and Phase : variance reduction 
